...
function AddAffilates() {
    ...
    return (
        ...
        <Container style={{ backgroundColor: "#ffffff" }}>
            <div className="page-content">
                <BreadCrumb title="제휴사 등록" pageTitle="제휴사목록" />
            ...
            <tbody >
                <tr >
                    ...
                    <td>  <div className="d-flex justify-content-start">
                            <Input type="text" placeholder="" style={{ width: '250px' }} className="me-2" />
                ...
                <tr >
                    ...
                    <td>  <div className="d-flex justify-content-start">
                            <Input type="text" placeholder="" style={{ width: '250px' }} className="me-2" />
                            <Button color="secondary fw-bold">충복확인</Button>
                        </div></td>
                ...
                <tr>
                    ...
                    <td><Input type="email" style={{ width: '250px' }} placeholder="" /></td>
  ...
  <option>탈퇴대기</option>
                ...
                <tr>
  <th className="text-center fw-bold p-3">제휴병원</th>
  <td className="text-start fw-bold p-3">
