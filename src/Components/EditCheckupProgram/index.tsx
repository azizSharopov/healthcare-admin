...
function EditCheckup() {
    ...
    return (
        ...
        // <Container style={{ backgroundColor: "#ffffff" }}>
            <div className="page-content">
                <BreadCrumb title="검진프로그램 수정" pageTitle="검진프로그램" />
  ...
  <option>미래의료재단</option>
                ...
                <tr>
                    ...
                    <td><Input type="text" style={{ width: '250px' }} placeholder="직장인A코스" /></td>
                  
                </tr>
                <tr>
                    <th className="text-center fw-bold p-4">검진비용</th>
                    <td><Input type="text" style={{ width: '250px' }} placeholder="200,000" /></td>
