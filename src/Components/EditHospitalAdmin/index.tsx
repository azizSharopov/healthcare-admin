...
function EditHospitalAdmin() {
    ...
    return (
        ...
        <div style={{ backgroundColor: "#ffffff" }}>
            <div className="page-content">
                <BreadCrumb title="병원수정" pageTitle="병원목록" />
  ...
  <option>탈퇴대기</option>
                ...
                <th className="text-center fw-bold p-4">연락처</th>
                    <td><Input style={{ width: '250px' }} type="text" placeholder="051-710-2000" /></td>
                </tr>
                <tr>
                <th style={{height: "120px"}} className="text-center fw-bold p-5">주소</th>
                    ...
                    <div className="d-flex justify-content-start">
                        ...
                        <p className="text-start fw-bold mt-2">상세주소</p>
                            <Input type="email" style={{ width: '550px', marginLeft: '35px' }} className="me-2" placeholder="4 층" />
